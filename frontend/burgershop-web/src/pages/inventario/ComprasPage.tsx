  ...
  return (
    <div className="space-y-4">
      ...
      <div className="sm:hidden bg-white rounded-lg shadow p-2 flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500 whitespace-nowrap">{movimientosFiltrados.length} compras</span>
      </div>
      ...
      <div className={(filtrosMobileVisibles ? 'block' : 'hidden') + ' sm:block bg-white rounded-lg shadow p-4'}>
        <div className="flex flex-wrap items-end gap-3">
          ...
          <button onClick={cargarMovimientos} className="hidden sm:block px-4 py-1.5 text-blue-700 bg-blue-50 border border-blue-300 rounded-md hover:bg-blue-100 text-sm font-semibold">Buscar</button>
          <button onClick={abrirModalNueva} className="hidden sm:flex px-4 py-1.5 text-emerald-700 bg-emerald-50 border border-emerald-300 rounded-md hover:bg-emerald-100 text-sm font-semibold items-center gap-1.5">
