  ...
  return (
    <div className="space-y-4">
      ...
      <div className="sm:hidden bg-white rounded-lg shadow p-2 flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500 whitespace-nowrap">{movimientosFiltrados.length} dev.</span>
      </div>
      ...
      <div className={(filtrosMobileVisibles ? 'block' : 'hidden') + ' sm:block bg-white rounded-lg shadow p-4'}>
        <div className="flex flex-wrap items-end gap-3">
          ...
          <button
            onClick={cargarMovimientos}
            className="hidden sm:flex px-4 py-1.5 text-blue-700 bg-blue-50 border border-blue-300 rounded-md hover:bg-blue-100 text-sm font-semibold transition-colors items-center gap-1.5"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
          ...
          <button
            onClick={abrirModal}
            className="hidden sm:flex px-4 py-1.5 text-emerald-700 bg-emerald-50 border border-emerald-300 rounded-md hover:bg-emerald-100 text-sm font-semibold transition-colors items-center gap-1.5"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
            </svg>
