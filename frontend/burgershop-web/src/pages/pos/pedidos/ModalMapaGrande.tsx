    ...
    >
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          <h3 id="mapa-grande-title" className="text-lg font-bold text-gray-800">Seleccionar ubicacion</h3>
          {coordenadas && (
            <span className="text-sm text-gray-500 truncate max-w-md">{direccion || 'Ubicacion seleccionada'}</span>
          )}
          <button onClick={onCerrar} className="text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg p-1.5 transition-colors" aria-label="Cerrar">
