...
namespace BurgerShop.Infrastructure.Migrations
{
    ...
    [Migration("20260505000917_AgregarHistorialPrecios")]
    partial class AgregarHistorialPrecios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.Categoria", b =>
                {
                    ...
                    b.Property<int>("TipoMegaCategoria")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.Combo", b =>
                {
                    ...
                    b.Property<bool>("EsOfertaSemanal")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.HistorialPrecio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.ListaPrecioDetalle", b =>
                {
                    ...
                    b.HasIndex("ListaPrecioId", "ComboId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.Producto", b =>
                {
                    ...
                    b.Property<decimal>("DiferenciaPrecioCosto")
                        .HasColumnType("numeric");

                    b.Property<bool>("EsOfertaSemanal")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("FechaUltimaModificacionPrecio")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.Promocion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.PromocionCondicion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PromocionId", "Tipo");

                    b.ToTable("PromocionCondiciones");
                });

            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.PromocionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PromocionItems");
                });

            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.PromocionLocal", b =>
                {
                    b.Property<int>("PromocionId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("PromocionId", "LocalId");

                    b.HasIndex("LocalId");

                    b.ToTable("PromocionLocales");
                });

            modelBuilder.Entity("BurgerShop.Domain.Entities.Catalogo.PromocionTipoVenta", b =>
                {
                    b.Property<int>("PromocionId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("PromocionId", "TipoVenta");

                    b.ToTable("PromocionTiposVenta");
                });
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Finanzas.CierreCaja", b =>
                {
                    ...
                    b.Property<int>("CantidadCtaCte")
                        .HasColumnType("integer");

                    b.Property<int>("CantidadDomicilio")
                        .HasColumnType("integer");

                    b.Property<int>("CantidadMostrador")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("MontoEfectivoReal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int?>("ResultadoRevision")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("TotalDomicilio")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalMostrador")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Finanzas.Gasto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Logistica.Repartidor", b =>
                {
                    ...
                    b.HasIndex("CodigoAcceso")
                        .IsUnique()
                        .HasFilter("\"CodigoAcceso\" IS NOT NULL");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Logistica.RepartoZona", b =>
                {
                    ...
                    b.Property<decimal>("MontoInicialCambio")
                        .HasColumnType("numeric");

                    b.Property<int>("RepartidorId")
                        .HasColumnType("integer");

                    b.Property<string>("TallyJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Ventas.Cliente", b =>
                {
                    ...
                    b.Property<int>("CondicionFiscal")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Ventas.LineaVenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BurgerShop.Domain.Entities.Ventas.Venta", b =>
                {
                    ...
                    b.Property<bool>("VencidoDeposito")
                        .HasColumnType("boolean");
