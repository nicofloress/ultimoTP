...
public record ListaPrecioDetalleDto(int Id, int? ProductoId, string? ProductoNombre, int? ComboId, string? ComboNombre, decimal Precio);
...
public record UpsertDetalleDto(int? ProductoId, int? ComboId, decimal Precio);
